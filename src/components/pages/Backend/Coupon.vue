<template>
  <div>
    ...
    <div class="text-right">
      <button class="btn btn-main mt-0 mt-md-5" @click="openModal(true)">
        建立新的優惠卷
      </button>
    </div>
      ...
      <ul class="pagination">
        <li class="page-item" :class="{ disabled: !pagination.has_pre }">
          <a
            ...
            href="#"
            aria-label="Previous"
            @click.prevent="getCouponData(pagination.current_page - 1)"
          >
        ...
        >
          <a class="page-link" href="#" @click.prevent="getCouponData(page)">{{
            page
          }}</a>
        </li>
