<template>
  <div>
    ...
    <div class="BMW_Background">
      <div class="banner_Lambo  align-items-center">
        <nav class="addresLambo d-flex  justify-content-center">
          <ol class="address-content  d-flex">
            <li class="homepage-item">
              <router-link to="/">首頁</router-link>
            </li>
            <li class="page-category">LAMBORGHINI</li>
          </ol>
        </nav>
        <div class="thumb-example mx-auto">
          ...
          >
            ...
            <swiper-slide class="slide-3"
              ><div class="contentswiper">
                <p>Lamborghini Aventador S Roadster</p>
              </div></swiper-slide
            >
            ...
            <swiper-slide class="slide-5"
              ><div class="contentswiper">
                <p>Lamborghini Huracan EVO Spyder</p>
              </div></swiper-slide
            >
            <div
        ...
        <div class=" d-flex col-md-12 d-flex justify-content-center">
          <div class="row mt-4 pt-5 d-flex justify-content-left">
            <div
              ...
              :key="item.id"
              v-if="item.category == 'Lamborghini'"
            >
              <div class="card  bg-dark text-light">
                ...
                <div class="card-body">
                  <span class="badge badge-secondary float-right ml-2 "
                    ><img
                      src="https://svgshare.com/i/UHA.svg"
                      alt=""
                      class="icon_Lambo"
                  /></span>
                  <h5 class="card-title">
...
.addresLambo {
  background: url("https://imgur.com/BOfv8B9.jpg");
  // float: left;
  width: 100%;
  // position: relative;
  background-attachment: fixed;
...
.swiper {
  .swiper-slide {
    ...
    &.slide-1 {
      background-image: url("https://images.unsplash.com/photo-1584890466736-b40b1c265dd8?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=3889&q=80");
    }
    &.slide-2 {
      background-image: url("https://images.unsplash.com/photo-1511919884226-fd3cad34687c?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&auto=format&fit=crop&w=2850&q=80");
    }
    &.slide-3 {
      background-image: url("https://wallpapercave.com/wp/wp2548654.jpg");
    }
    &.slide-4 {
      background-image: url("https://imgur.com/bghgV69.jpg");
    }
    &.slide-5 {
      background-image: url("https://wallpapercave.com/wp/wp6041631.jpg");
    }
  }
