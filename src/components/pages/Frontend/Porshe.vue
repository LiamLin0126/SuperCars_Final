<template>
  <div>
    ...
    <div class="BMW_Background">
      <div class="banner_Porshe  align-items-center">
        <nav class="address_Porshe d-flex  justify-content-center">
          <ol class="address-content  d-flex">
            <li class="homepage-item">
              <router-link to="/">首頁</router-link>
            </li>
            <li class="page-category">PORSCHE</li>
          </ol>
        </nav>
        <div class="thumb-Porsche mx-auto">
          <!-- swiper1 -->
          <swiper
            class="swiper-Porsche gallery-top"
          ...
          <!-- swiper2 Thumbs -->
          <swiper
            class="swiper-Porsche gallery-thumbs"
              ...
              <div class="card  bg-dark text-light">
                ...
                <div class="card-body">
                  <span class="badge badge-secondary float-right ml-2 "
                    ><img
                      src="https://imgur.com/GTCdZY3.png"
                      alt=""
                      class="icon_Porsche"
                  /></span>
...
.address_Porshe {
  background: url("https://images.unsplash.com/photo-1595418594929-db66bc77ae04?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2850&q=80");
  // float: left;
  width: 100%;
  // position: relative;
...
.swiper-Porsche {
  .swiper-slide {
    ...
    &.slide-1 {
      background-image: url("https://images.unsplash.com/photo-1500509178313-4eaf2867f500?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=2850&q=80");
    }
    &.slide-2 {
      background-image: url("https://images.unsplash.com/photo-1611859266720-147cc87658f1?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=3889&q=80");
    }
    &.slide-3 {
      background-image: url("https://imgur.com/vsP1dg6.jpg");
    }
    &.slide-4 {
      background-image: url("https://wallpapercave.com/wp/wp2678889.jpg");
    }
    &.slide-5 {
      background-image: url("https://wallpapercave.com/wp/wp2157582.jpg");
    }
  }
